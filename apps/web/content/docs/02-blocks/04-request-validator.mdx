...
<SourceCode file="blocks/request-validator/adapters/express.ts" />
...
<SourceCode file="blocks/request-validator/adapters/fastify.ts" />

### blocks/request-validator/adapters/hono.ts

Hono middleware that validates requests and exposes `validated(c)`.

<SourceCode file="blocks/request-validator/adapters/hono.ts" />
